...
export default function EditTask({ show, handleClose, task, handleSave }) {
    ...
    const [limitDate, setLimitDate] = useState(task.limit_date);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header bg-secondary">
                        ...
                        <button type="button" className="close btn btn-danger btn-sm ms-auto" data-dismiss="modal" aria-label="Close" onClick={handleClose}>
